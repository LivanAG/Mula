...
$(function(){
    ...
    CargarTablaEnvios({'action':'listar'});

    
    CargarTablaGastosExtras({'action':'listar_gastos_extras'});
    ...
    $("#id_Gasto_total_en_pasajes").change(function() {
        ...
        console.log(valor_pasajes_anterior)
   ...
   $("#gasto_extra")
    ...
    $("#form").on("submit",function(e){
        ...
        parametros.append('action',"crear_envio");
        ...
        enviar_con_ajax(window.location.pathname,parametros,'Estas a punto de crear un envio!',"Desea continuar?","ModalError",function(){
