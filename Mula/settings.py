"""
Django settings for Mula project.
...
ROOT_URLCONF = 'Mula.urls'
ruta = os.path.join(BASE_DIR, 'Apps\Controlador', 'templates\Controlador')
...
WSGI_APPLICATION = 'Mula.wsgi.application'
...
EMAIL_HOST_PASSWORD="ndguxakhuczxbnvp"
